...
// ... (省略未修改的 Skills, Quests, Races, NPCs, MONSTERS, BASE_TAGS)
// 请保留原有的 RACE_SKILL_TREES, QUEST_POOL, RACES, RACE_NPCS, MONSTERS, TAG_DEFS
...
// [Fix V3.1] 修复 cals -> calories，确保默认数据有热量
