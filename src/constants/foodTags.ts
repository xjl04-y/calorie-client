...
export const TAG_DEFS: Record<string, TagDefinition> = {
  ...BASE_TAGS,
  // 英文别名映射
  HIGH_SUGAR: BASE_TAGS.高糖 || { label: '高糖', icon: '🍬', desc: '容易导致血糖飙升' },
  HIGH_FAT: BASE_TAGS.高油 || { label: '高油', icon: '🛢️', desc: '脂肪含量高' },
  HIGH_SODIUM: BASE_TAGS.高盐 || { label: '高盐', icon: '🧂', desc: '钠含量过高' },
  HIGH_CARB: BASE_TAGS.高碳 || { label: '高碳', icon: '🍚', desc: '碳水化合物丰富' },
  HIGH_PRO: BASE_TAGS.高蛋白 || { label: '高蛋白', icon: '💪', desc: '增肌首选' },
  CLEAN: BASE_TAGS.纯净 || { label: '纯净', icon: '✨', desc: '无添加健康' },
  BALANCED: BASE_TAGS.均衡 || { label: '均衡', icon: '⚖️', desc: '营养比例完美' }
};
